...
class RequestManager {
    ...
    static func getCategories( completionHandler:@escaping ([Category]?,Error?)->Void){
        ...
        AF.request(Constants.baseurl + "categories", method: .get, headers: headers).responseDecodable(of: Categories.self) { response in
            ...
            case .success:
                ...
                //print(categories)
                completionHandler(categories.data,response.error)
                break
            case .failure:
    ...
    static func getProducts( completionHandler:@escaping ([Product]?,Error?)->Void){
        ...
        AF.request(Constants.baseurl + "products?include=category", method: .get, headers: headers).responseDecodable(of: products.self) { response in
            ...
            case .success:
                ...
                //print(categories)
                completionHandler(products.data,response.error)
                break
            case .failure:
                completionHandler(nil, response.error)
                break
